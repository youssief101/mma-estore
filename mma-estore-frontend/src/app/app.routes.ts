...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'sale', component: ProductList },
      ...
      { path: 'order-success/:orderNumber', loadComponent: () => import('./features/orders/order-success/order-success').then(m => m.OrderSuccessComponent) },
